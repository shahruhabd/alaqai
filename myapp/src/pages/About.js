    ...
    <div className='about_wrapper' id='about'>
        ...
        <div className="about_content">
            <div className='about_prg'>
                <div className='about_prg_title'>Наш детский образовательный центр Алакай Стади: Развитие, Учеба и Веселье в Гармонии</div>
                <div className='about_prg_text'>Добро пожаловать в наш детский образовательный центр Alaqai study, где мы стремимся создать уникальное пространство для всестороннего развития вашего ребенка. Наш центр предлагает широкий спектр программ, направленных на умственное, творческое и физическое развитие детей в приятной и поддерживающей атмосфере.</div>
            </div>
            <div className='about_prg'>
            ...
            <div className='about_prg'>
                ...
                <div className='about_prg_text'>Мы приглашаем вас и вашего ребенка на бесплатное пробное занятие в Алакай Стади, чтобы лично убедиться в теплой и дружественной атмосфере нашего центра. Свяжитесь с нами, чтобы узнать больше о том, как мы можем вместе помочь вашему ребенку достичь новых высот!</div>
            </div>
        </div>
